...
export class AutoCompleteDirective implements OnInit, OnDestroy, ControlValueAccessor {
  ...
  constructor(private elementRef: ElementRef, private viewContainerRef: ViewContainerRef,
              ...
              private adminlteNGConfig: AdminlteNGConfig, private changeDetectorRef: ChangeDetectorRef) {
    this.valueChanges = this.registerInputEvent(elementRef);
    this.delay = adminlteNGConfig.autoComplete.delay;
    this.minLength = adminlteNGConfig.autoComplete.minLength;
    this.itemTemplate = adminlteNGConfig.autoComplete.itemTemplate;
    this.noResultItemTemplate = adminlteNGConfig.autoComplete.noResultItemTemplate;
    this.formatter = adminlteNGConfig.autoComplete.formatter;
    this.valueParser = adminlteNGConfig.autoComplete.valueParser;
  }
  ...
  ngOnInit() {
    ...
    const viewContainerRef = this.appendBody ? this.adminlteNGConfig.rootContainer : this.viewContainerRef;
